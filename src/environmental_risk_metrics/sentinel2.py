...
class Sentinel2:
    ...
    def load_xarray(
        ...
        if cropped_image_cloud_cover_threshold:
            ...
            logger.debug(
                f"Cloud cover percentage: {cloud_cover_pct}. Filtering data based on {cropped_image_cloud_cover_threshold}% cloud cover threshold"
            )
            ...
            logger.info(
                f"Filtered dataset to {len(ds.time)} time steps based on {cropped_image_cloud_cover_threshold}% cloud cover threshold"
            )
